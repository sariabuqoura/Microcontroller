...
$0303	$0188			CLRF	TRISD, 1
;ADC2.pbas,8 :: 		portd=0
$0304	$1283			BCF	STATUS, RP0
$0305	$0188			CLRF	PORTD, 1
;ADC2.pbas,10 :: 		lcd_init (portb)
$0306	$3006			MOVLW	PORTB
$0307	$00B2			MOVWF	FARG_Lcd_Init
$0308	$2214			CALL	_lcd_init
;ADC2.pbas,11 :: 		lcd_cmd (lcd_cursor_off)
$0309	$300C			MOVLW	12
$030A	$00BF			MOVWF	FARG_Lcd_Cmd
$030B	$2020			CALL	_lcd_cmd
;ADC2.pbas,12 :: 		lcd_cmd (lcd_clear)
$030C	$3001			MOVLW	1
$030D	$00BF			MOVWF	FARG_Lcd_Cmd
$030E	$2020			CALL	_lcd_cmd
;ADC2.pbas,14 :: 		adcon1= %00000000
$030F	$1683			BSF	STATUS, RP0
$0310	$019F			CLRF	ADCON1, 1
;ADC2.pbas,16 :: 		run:
$0311	$	_main_run:
;ADC2.pbas,17 :: 		x = adc_read (0)
$0311	$1283			BCF	STATUS, RP0
$0312	$01B2			CLRF	FARG_ADC_read, 1
$0313	$2229			CALL	_adc_read
$0314	$0870			MOVF	STACK_0, 0
$0315	$00AA			MOVWF	_x
$0316	$0871			MOVF	STACK_0+1, 0
$0317	$00AB			MOVWF	_x+1
;ADC2.pbas,18 :: 		if x>500 then
$0318	$0871			MOVF	STACK_0+1, 0
$0319	$3C01			SUBLW	1
$031A	$1D03			BTFSS	STATUS, Z
$031B	$2B1E			GOTO	L_main_0
$031C	$0870			MOVF	STACK_0, 0
$031D	$3CF4			SUBLW	244
$031E	$	L_main_0:
$031E	$1803			BTFSC	STATUS, C
$031F	$2B22			GOTO	ADC2_L_2
$0320	$	ADC2_L_1:
;ADC2.pbas,19 :: 		portd.0=1
$0320	$	ADC2_L_4:
$0320	$1408			BSF	PORTD, 0
$0321	$	ADC2_L_5:
$0321	$2B23			GOTO	ADC2_L_3
;ADC2.pbas,20 :: 		else
$0322	$	ADC2_L_2:
;ADC2.pbas,21 :: 		portd.0=0
$0322	$1008			BCF	PORTD, 0
$0323	$	ADC2_L_7:
;ADC2.pbas,22 :: 		end if
$0323	$	ADC2_L_3:
;ADC2.pbas,23 :: 		wordtostr (x,y)
$0323	$082A			MOVF	_x, 0
$0324	$00B2			MOVWF	FARG_WordToStr
$0325	$082B			MOVF	_x+1, 0
$0326	$00B3			MOVWF	FARG_WordToStr+1
$0327	$302C			MOVLW	_y
$0328	$00B4			MOVWF	FARG_WordToStr+2
$0329	$2268			CALL	_wordtostr
;ADC2.pbas,24 :: 		lcd_out (1,1,y)
$032A	$3001			MOVLW	1
$032B	$00B2			MOVWF	FARG_Lcd_Out
$032C	$3001			MOVLW	1
$032D	$00B3			MOVWF	FARG_Lcd_Out+1
$032E	$302C			MOVLW	_y
$032F	$00B4			MOVWF	FARG_Lcd_Out+2
$0330	$22C2			CALL	_lcd_out
;ADC2.pbas,26 :: 		goto run
$0331	$2B11			GOTO	_main_run
$0332	$2B32			GOTO	$
